...
Imagine you have a giant robot friend, and you want to make sure its heart is beating right, it's not too hot, and it's happy. **FactSense** is the tool you use to do that!
...
1.  **Download it**: Click the green **Code** button at the top and pick **Download ZIP**, OR if you are a pro, type this in your terminal:
    ```bash
    git clone https://github.com/Harikesh10/FactSense.git
    ```
2.  **Open the folder**: Go into the folder you just downloaded:
    ```bash
    cd FactSense
    ```
...
The brain talks to the machines and saves all the data.
...
The face is what you see and click on.
...
*   **`backend/`**: These are the "behind-the-scenes" files. It has the server, the database settings, and the machine simulator.
*   **`frontend/`**: These are the files for the website you see. It has the HTML (bones), CSS (clothes/design), and JS (muscles/actions).
*   **`assets/`**: Where we keep images and icons.
...
*   **Database**: MongoDB (to remember everything).
*   **Icons**: Lucide Icons.
